...
1. Download [org.kde.plasma.geminiquery.plasmoid](org.kde.plasma.geminiquery.plasmoid) and run `kpackagetool6 -t Plasma/Applet -i org.kde.plasma.geminiquery.plasmoid`
